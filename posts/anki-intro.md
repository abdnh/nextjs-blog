...
:img{src="anki-main-window.png" caption="نافذة أنكي الرئيسية"}

اضغط على زر **إضافة** في الأعلى لكي تظهر لك نافذة إدخال المعلومات التالية:

:img{src="anki-add-window.png" caption="نافذة إضافة البطاقات في أنكي"}
...
:img{src="anki-filled-add-window.png" caption="نافذة إضافة البطاقات في أنكي مع معلومات مدخلة"}
...
:img{src="anki-main-window-with-new-cards.png" caption="نافذة أنكي الرئيسية بعد إضافة بطاقتين"}

لننقر على «افتراضية» يظهر لنا التالي:

:img{src="anki-overview-screen.png" caption="شاشة موجز الرزمة في أنكي"}

لننقر على «ادرس الآن» لنرى ما سيحصل.

:img{src="anki-review-front.png" alt="جانب بطاقة أمامي في أنكي"}
...
:img{src="anki-review-back.png" alt="جانب بطاقة خلفي في أنكي"}
...
:img{src="anki-review-front-2.png" alt="مراجعة بطاقة ثانية في أنكي"}

لنقل إننا وجدنا هذه الكلمة سهلة أيضا لذلك أجبنا عنها فورا وضغطنا على زر «سهل»، لتظهر لنا الشاشة التالية:

:img{src="anki-congrats-screen.png" caption="شاشة التهنئة في أنكي"}

انتهينا من دراسة هذه الرزمة المكونة من بطاقتين. إذا عدنا إلى الشاشة الرئيسية بالضغط
على زر «رزم» في الأعلى فسنرى التالي:

:img{src="anki-main-window-after-studying-new-cards.png" caption="شاشة قائمة الرزم في أنكي بعد دراسة بطاقتين"}
...
:img{src="anki-main-window-with-due-cards.png" caption="شاشة أنكي الرئيسية بعد 4 أيام"}
...
:img{src src="anki-review-back-after-4-days.png" caption="مراجعة بطاقة مجددا بعد 4 أيام"}
...
وهذا ما يفسر تباعد فترات المراجعة في أنكي وتقاربها حسب الصعوبة: مهمة أنكي هي _جدولة_ المراجعات لك
...
يمكن تمثيل فكرة تلاشي الذكريات مع الوقت بما يسمى _بمنحنى النسيان_، أو منحنى إبنجهاوس،
...
:img{src="ltm/Ebbinghaus.png" caption="رسم بياني يظهر منحنى النسيان في حال تعلم معلومة وعدم مراجعتها بعد ذلك"}

:img{src="ltm/Ebbinghaus_repeat.png" caption="رسم بياني يظهر انخفاض انحدار معدل النسيان مع كل مراجعة"}
...
:img{src="anki-review-back-2-after-4-days.png" caption="مراجعة البطاقة الثانية بعد 4 أيام"}
...
:img{src="anki-card-2-after-failed-review.png" caption="أوقات مراجعة البطاقة الثانية بعد مراجعة فاشلة"}
...
:img{src="anki-congrats-screen.png" alt="شاشة التهنئة في أنكي"}
...
:img{src="anki-card-with-large-interval.png" caption="بطاقة لها فاصل زمني كبير"}
